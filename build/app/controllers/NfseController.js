...
exports.NfseController = {
    ...
    enviarLoteRps: function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, xml, debug, nfseService, xmlSigned, result, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = req.body, xml = _a.xml, debug = _a.debug;
                        if (!xml || typeof xml !== "string") {
                            throw new api_errors_1.BadRequestError("XML do lote não informado");
                        }
                        nfseService = new NfseSpService_1.NfseSpService();
                        // Se debug=true, retorna apenas o XML assinado sem enviar
                        if (debug) {
                            xmlSigned = nfseService.signXml(xml);
    ...
    consultarLote: function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var protocolo, nfseService, result, error_2;
    ...
    cancelarNfse: function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, nfseNumber, motivo, nfseService, result, invoice, error_3;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
