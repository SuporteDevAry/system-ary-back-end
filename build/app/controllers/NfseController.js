                ...
                switch (_b.label) {
                    case 0:
                        ...
                        if (!xml || typeof xml !== "string") {
                            throw new api_errors_1.BadRequestError(
                                "XML do lote não informado",
                            );
                        }
                        nfseService = (0,
                        NfseServiceAdapter_1.getNfseService)();
                        ...
                        if (debug && activeProvider === "prefeitura") {
                            prefeituraService =
                                new NfseSpService_1.NfseSpService();
                            xmlSigned = prefeituraService.signXml(xml);
                            return [
                                2 /*return*/,
                                res.status(200).json({
                                    message:
                                        "XML assinado (não enviado - modo debug)",
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        console.log(
                            "\uD83D\uDD0D Consultando "
                                .concat(protocolo, " via ")
                                .concat(activeProvider, "..."),
                        );
                        return [
                            4 /*yield*/,
                            nfseService.consultarLote(protocolo),
                        ];
                    case 1:
                        result = _a.sent();
                        return [
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
                        ((_a = req.body),
                            (nfseNumber = _a.nfseNumber),
                            (motivo = _a.motivo),
                            (provider = _a.provider));
                        if (!nfseNumber || !motivo) {
                            throw new api_errors_1.BadRequestError(
                                "Número da NFS-e e motivo são obrigatórios",
                            );
                        }
                        nfseService = (0,
                        NfseServiceAdapter_1.getNfseService)();
                        ...
                        console.log(
                            "\u274C Cancelando "
                                .concat(nfseNumber, " via ")
                                .concat(activeProvider, "..."),
                        );
                        return [
                            4 /*yield*/,
                            nfseService.cancelarNfse(nfseNumber, motivo),
                        ];
                    case 1:
                        result = _b.sent();
                        return [
                            4 /*yield*/,
                            InvoiceRepository_1.InvoiceRepository.findByNfs_number(
                                nfseNumber,
                            ),
                        ];
                    case 2:
                ...
                try {
                    ...
                    return [
                        ...
                        res.status(200).json({
                            ...
                            provider: activeProvider,
                            ambiente: (
                                (_a = process.env.SOAP_ENDPOINT) === null ||
                                _a === void 0
                                    ? void 0
                                    : _a.includes("homologacao")
                            )
                                ? "HOMOLOGAÇÃO"
                                : "PRODUÇÃO",
                            prestador: {
