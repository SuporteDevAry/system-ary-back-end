...
exports.ProductController = {
    createProduct: function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ProductRepository_1.ProductRepository.create(req.body)];
                    case 1:
                        product = _a.sent();
    ...
    findAllProducts: function (_, res) {
        return __awaiter(this, void 0, void 0, function () {
            var products;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, ProductRepository_1.ProductRepository.findAll()];
                    case 1:
                        products = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = req.params.id;
                        return [4 /*yield*/, ProductRepository_1.ProductRepository.findById(id)];
                    case 1:
                        product = _a.sent();
                        if (!product)
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = req.params.id;
                        return [4 /*yield*/, ProductRepository_1.ProductRepository.update(id, req.body)];
                    case 1:
                        updated = _a.sent();
