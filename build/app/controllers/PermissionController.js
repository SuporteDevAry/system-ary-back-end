...
var PermissionController = /** @class */ (function () {
    ...
    PermissionController.prototype.update = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, rules, permission, updatedPermission;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = req.params.id;
                        rules = req.body.rules;
                        return [4 /*yield*/, PermissionRepository_1.permissionRepository.findOneBy({ id: id })];
                    case 1:
                        permission = _a.sent();
                        if (!permission) {
                    ...
                    case 2:
                        updatedPermission = _a.sent();
                        return [2 /*return*/, res.json(updatedPermission)];
                }
            });
        });
    };
