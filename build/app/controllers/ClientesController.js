...
var ClientesRepository_1 = require("../repositories/ClientesRepository");
var api_errors_1 = require("../helpers/api-errors");
var ClientesController = /** @class */ (function () {
    function ClientesController() {
    }
    ClientesController.prototype.getProfile = function (req, res) {
    ...
    ClientesController.prototype.getClientes = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var clientes;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, ClientesRepository_1.getClientes)()];
                    case 1:
                        clientes = _a.sent();
    ...
    ClientesController.prototype.getClienteById = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, ClientesRepository_1.clientesRepository.findOneBy({ cli_codigo: cli_codigo })];
                    case 1:
    ...
    ClientesController.prototype.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, id, cli_codigo, nome, endereco, numero, complemento, bairro, cidade, uf, cep, natureza, cnpj, ins_est, ins_mun, email, telefone, celular, situacao, clienteExists, newCliente, clientes;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        newCliente = ClientesRepository_1.clientesRepository.create({
                            id: id,
                        ...
                        return [4 /*yield*/, ClientesRepository_1.clientesRepository.save(newCliente)];
                    case 2:
                        _b.sent();
                        clientes = __rest(newCliente, []);
                        return [2 /*return*/, res.status(201).json(clientes)];
                }
            });
        });
    };
    ClientesController.prototype.updateCliente = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, ClientesRepository_1.clientesRepository.save(clienteToUpdate)];
                    case 2:
                        _b.sent();
    ...
    ClientesController.prototype.deleteCliente = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, ClientesRepository_1.clientesRepository.remove(clienteToDelete)];
                    case 2:
                        _a.sent();
