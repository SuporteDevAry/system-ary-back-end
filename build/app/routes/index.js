...
const GrainContractController_1 = require("../controllers/GrainContractController");
...
routes.get("/api-cnpj/cnpj/:cnpj", async (req, res) => {
    ...
    try {
        const response = await (0, node_fetch_1.default)(`https://receitaws.com.br/v1/cnpj/${cnpj}`);
