...
var repo = data_source_1.AppDataSource.getRepository(ProductsTable_1.ProductTable);
    ...
    create: function (data) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        table = repo.create(data);
                        return [4 /*yield*/, repo.save(table)];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!table)
                            throw new Error("Mesa de produto não encontrada");
                        return [4 /*yield*/, repo.remove(table)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
