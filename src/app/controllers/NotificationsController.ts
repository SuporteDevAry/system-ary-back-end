...
import { getNotifications, notificationsRepository } from "../repositories/NotificationsRepository";
...
export class NotificationController {
    ...
    async getNotificationsByUser(req: Request, res: Response) {
        ...
        const notificationsSearched = await notificationsRepository.findBy({ user });
    ...
    async getNotificationById(req: Request, res: Response) {
        ...
        const notificationsSearched = await notificationsRepository.findOneBy({ id });
    ...
    async updateNotification(req: Request, res: Response) {
        ...
        const notificationToUpdate = await notificationsRepository.findOneBy({ id });
    ...
    async deleteNotification(req: Request, res: Response) {
        ...
        const notificationToDelete = await notificationsRepository.findOneBy({ id });
